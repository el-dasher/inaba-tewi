...
class OsuStats(object):
    ...
    def deltaStrain(self, difftype: int, PrevObject: OsuHitObject, NowObject: OsuHitObject,
                    Difficulty: OsuDifficulty) -> None:
        """
    ...
    def deltaSpacingWeightAim(self, difftype: int, delta_distance: float, delta_time: float, prev_delta_distance: float,
                              prev_delta_time: float, angle: float) -> tuple:
    ...
    def deltaSpacingWeightSpeed(self, difftype: int, delta_distance: float, delta_time: float,
                                prev_delta_distance: float, prev_delta_time: float, angle: float) -> tuple:
